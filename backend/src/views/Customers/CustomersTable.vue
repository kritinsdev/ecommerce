  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
            ...
            <Menu as="div" class="relative inline-block text-left">
              <div>
                <MenuButton
                  ...
                  <DotsVerticalIcon class="h-5 w-5 text-emerald-500" aria-hidden="true" />
                </MenuButton>
              </div>
    ...
    <div v-if="!customers.loading" class="flex justify-between items-center mt-5">
      ...
      <nav v-if="customers.total > customers.limit"
        ...
        <a v-for="(link, i) of customers.links" :key="i" :disabled="!link.url" href="#" @click="getForPage($event, link)"
          aria-current="page"
